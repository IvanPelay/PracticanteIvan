...
--   v5: Se elimina t_ColumnasConfig (JSON) de Plantillas.
--       Se agregan i_FilaInicio e i_ColumnaInicio para volcado directo vía EPPlus.
--
-- ORDEN DE EJECUCIÓN:
--   1. Cat016ConsultasReporteador  (nuevo catálogo de consultas)
--   2. Cat016PlantillasReporteador (plantillas — sin config JSON de columnas)
...
EXEC sp_addextendedproperty @name=N'MS_Description',
    @value=N'Catálogo de consultas para reportes. Solo DBA/Dev registran aquí. t_NombreVista es obligatoria. t_NombreSP es opcional.',
...
--   v5: Se eliminan las columnas JSON, se usa Fila/Columna Inicio
-- ===================================================================
CREATE TABLE [dbo].[Cat016PlantillasReporteador] (
    ...
    -- Coordenadas de inicio para inyección de datos
    i_FilaInicio      INT          NOT NULL CONSTRAINT DF_Cat016Pla_Fila    DEFAULT (1),
    i_ColumnaInicio   INT          NOT NULL CONSTRAINT DF_Cat016Pla_Columna DEFAULT (1),
...
EXEC sp_addextendedproperty @name=N'MS_Description',
    @value=N'Catálogo de plantillas de reportes. Referencia a Cat016ConsultasReporteador. Usa i_FilaInicio e i_ColumnaInicio para inyección nativa en Excel.',
    @level0type=N'SCHEMA',@level0name=N'dbo',
    @level1type=N'TABLE', @level1name=N'Cat016PlantillasReporteador'
GO

-- ===================================================================
-- TABLA 3: Enc016ValidacionesReporteador (Uso futuro)
-- ===================================================================
...
CREATE TABLE [dbo].[Enc016ProgramacionReporteador] (
    ...
    t_Parametros       VARCHAR(MAX) NULL,       -- JSON con valores
...
CREATE TABLE [dbo].[Bit016GeneracionReporteador] (
    ...
    t_Error                TEXT         NULL,
    t_ParametrosUsados     VARCHAR(MAX) NULL,       -- JSON con los parámetros reales usados
...
-- ===================================================================
-- VISTA 1: Vig016ProgramacionesPendientes (Motor de consola)
-- ===================================================================
...
--  Nombre              Llave  Longitud  TipoDato  Visible  NombreColumna              Insert  Modif   Default   Filtro
    ...
    UNION ALL SELECT 'i_FilaInicio',       0, 10,         1, 1, 'Fila Inicio',              1, 1, '1',   '0'
    UNION ALL SELECT 'i_ColumnaInicio',    0, 10,         1, 1, 'Columna Inicio',           1, 1, '1',   '0'
    ...
    UNION ALL SELECT 'f_FechaRegistro',    0, 23,         4, 1, 'Fecha Registro',           0, 0, '',    '2'
    UNION ALL SELECT 't_UsuarioRegistro',  0, 50,         1, 1, 'Usuario Registro',         0, 0, '',    '2'
    UNION ALL SELECT 'i_Cve_Estatus',      0, 1,          0, 1, 'Estatus',                  1, 1, '1',   '2' 
    UNION ALL SELECT 'i_Cve_Estado',       0, 1,          0, 1, 'Estado',                   1, 0, '1',   '2' 
) AS VE
GO
...
-- ===================================================================
PRINT '======================================================='
PRINT 'MÓDULO REPORTEADOR KROM - FAMILIA 016 (SCRIPT COMPLETO v5)'
PRINT '======================================================='
